...
author: "Zhiyuan Zhang, Kushal Regmi, Sidhart Sathya"
date: "Due: 12/15/21"
...
(A) .Rmd Line numbers where at least two different data sources are imported:  42-43


(B) .Rmd Line numbers for inspecting data intake:  50-62


### Data Wrangling / Cleaning / ect (5 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 79-85


(B) .Rmd Line number(s) for a join operation: 95
...
(F) .Rmd Line number(s) for use of user-defined functions: 115


(G) .Rmd Line number(s) for use of loops and/or control flow: 142-156
...
(A) .Rmd Line numbers for use of multiple different geoms:  161

(B) .Rmd Line number(s) for use of multiple aesthetics:  162

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  

(E) .Rmd Line number(s) for use of decision tree or dendogram results: 240-245
